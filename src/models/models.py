...
class PlayerCount(Base):
    ...
    players = relationship("Player", secondary=player_snapshot_association, back_populates="snapshots")
...
class Player(Base):
    ...
    snapshots = relationship("PlayerCount", secondary=player_snapshot_association, back_populates="players")