...
class TestAcquireLock:
    ...
    def test_acquire_lock_concurrent_access_prevention(self):
        ...
        with patch('builtins.open', return_value=mock_file):
            with patch('fcntl.lockf', side_effect=IOError("Resource temporarily unavailable")):
...
'''
        ...
        try:
            ...
            lock_holder = subprocess.Popen([sys.executable, '-c', lock_holder_script],
            ...
            lock_tester = subprocess.Popen([sys.executable, '-c', lock_tester_script],
                                         stdout=subprocess.PIPE,
                                         stderr=subprocess.PIPE,
                                         text=True)
