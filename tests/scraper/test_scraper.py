...
class TestLoadServers:
    ...
    def test_load_servers_valid_json(self):
        ...
        servers_data = [
            ...
            {"id": "test2", "name": "Test Server 2", "ip": "example.com", "port": 25566}
        ]
...
class TestScrapeAllServers:
    ...
    async def test_scrape_all_servers_multiple(self):
        ...
        expected_results = [
            ...
            {'server_id': 'server2', 'player_count': 1, 'players': ['Player2'], 'success': True}
        ]
    ...
    async def test_scrape_all_servers_mixed_results(self):
        ...
        expected_results = [
            {'server_id': 'server1', 'player_count': 3, 'players': ['Player1'], 'success': True},
            {'server_id': 'server2', 'player_count': 0, 'players': [], 'success': False}
        ]
